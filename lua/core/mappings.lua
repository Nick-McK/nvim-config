...
M.general = {
	n = {
		...
		["<leader>th"] = {
			...
			desc = "Opens Theme Switcher Menu"
		},
		...
		["<leader>ht"] = {
			...
			desc = "Opens Horizontal Terminal"
		},
		["<leader>vt"] = {
			function()
				require("terminal").terminal_vertical()
			end,
			desc = "Opens Vertical Terminal"
		},
		-- DEBUG WINDOW
		["<leader>dw"] = {
			function()
		...
		["<leader>st"] = {
			...
			desc = "Shows a list of terminals"
		},
		...
		["<C-n>"] = { "<CMD>lua require('oil').toggle_float()<CR>", desc = "Toggle File Browser" },
...
M.telescope = {
	n = {
		...
		["<leader>fW"] = {
			function()
				require("telescope.builtin").grep_string({ word_match = "-w", search = vim.fn.input("Grep for > ") })
			end,
			desc = "Find Word (root)"
		},
